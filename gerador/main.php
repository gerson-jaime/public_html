                    ...
                    <section id="section_R">
                        ...
                        <div class='sub_section'>
                            ...
                            <div class="info" id="info_R">
                                <p class="infoHeader"><i class='bx bx-chip'></i> Dados da fase R-N</p>
                                <div class="elementos">
                                    <div class="grandeza">
                                        <ul type="none">
                                    ...
                                    <div class="valores" id="tensoes_R">
                                        <ul type="none">
                                            <li><span id="potencia_R">10</span> W </li>
                                            <li><span id="energia_R">25</span> Wh</li>
                                            <li><span id="factor_R">30</span> </li>
                                            <li><span id="frequencia_R">10</span> Hz</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section id="section_S">
                        ...
                        <div class='sub_section'>
                            ...
                            <div class="info" id="info_S">
                                <p class="infoHeader"><i class='bx bx-chip'></i> Dados da fase S-N</p>
                                <div class="elementos">
                                    <div class="grandeza">
                                        <ul type="none">
                                            <li> <span>&#10023;</span> Potência
                    ...
                    <section id="section_T">
                        ...
                        <div class='sub_section'>
                            ...
                            <div class="info" id="info_T">
                                <p class="infoHeader"><i class='bx bx-chip'></i> Dados da fase T-N</p>
                                <div class="elementos">
                                    <div class="grandeza">
                                        <ul type="none">
                                            <li> <span>&#10023;</span> Potência
